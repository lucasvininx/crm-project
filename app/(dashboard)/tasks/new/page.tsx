      ...
      <Card>
        <form onSubmit={handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>Preencha os dados da nova tarefa.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {formData.related_to_type === "customer" && formData.related_to_type !== "none" && (
              <div className="space-y-2">
            ...
            {formData.related_to_type === "deal" && formData.related_to_type !== "none" && (
              <div className="space-y-2">
